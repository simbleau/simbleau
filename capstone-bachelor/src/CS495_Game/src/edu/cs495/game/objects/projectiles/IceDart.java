 ...
 * @author Spencer
 */
public class IceDart extends AbstractDart {
	
	/** The sprite sheet for the blast */
	private static final String IMAGE_PATH = "/equipment/spells/ice_dart.png";
	...
	private static final int BLOOM_RGB = 0x00cfff;
	 ...
	 */
	public IceDart( Point origin, double theta, int speed, Player sender) {
		super(
				IMAGE_PATH, 
				IMAGE_WIDTH, 
				IMAGE_HEIGHT, 
	 ...
	 * @param origin - the origin of this blast
	 */
	public IceDart(Point origin, double theta, Player sender) {
		super(
				IMAGE_PATH, 
				IMAGE_WIDTH, 
				IMAGE_HEIGHT, 
	...
	public void init(GameDriver gameDriver) {
		...
		dartSpriteSheet.bakeAll(alphaFilter);
	}
