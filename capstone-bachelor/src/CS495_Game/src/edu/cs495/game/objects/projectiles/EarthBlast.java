...
/** An earth blast spell
 * 
 * @version February 2019
 * @author Spencer Imbleau
 */
public class EarthBlast extends AbstractBlast {
	/** The sprite sheet for the blast */
	private static final String SPRITE_SHEET = "/equipment/spells/earth_blast.png";
	...
	private static final int BLOOM_RGB = 0x00ff00;
	 ...
	 */
	public EarthBlast( Point origin, double theta, int speed, Player sender) {
		super(
				SPRITE_SHEET, 
				TILE_WIDTH, 
				TILE_HEIGHT, 
	 ...
	 * @param origin - the origin of this blast
	 */
	public EarthBlast( Point origin, double theta, Player sender) {
		super(
				SPRITE_SHEET, 
				TILE_WIDTH, 
				TILE_HEIGHT, 
