...
import edu.cs495.engine.gfx.obj.Image;
	 ...
	 */
	public class ShortSign extends AbstractScenery{
		
	/** The file path for the scenery image */
	private static final String IMAGE_PATH = "/map/common/short_sign.png";
	 ...
	 */
	public ShortSign(String text, Font font, float posX, float posY) {
