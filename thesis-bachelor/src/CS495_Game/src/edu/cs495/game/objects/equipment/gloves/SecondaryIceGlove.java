...
import edu.cs495.game.objects.projectiles.IceDart;

/** An ice dart glove (best middle tier)
 * 
 * @version February 2019
 * @author Spencer Imbleau
 */
public class SecondaryIceGlove extends AbstractGlove{
	...
	public void shoot(GameDriver gameDriver, Player sender, Point origin, double theta) {
		if (timer < 0) {
			AbstractDart dart = new IceDart(origin, theta, sender);
