 ...
 */
public class TopLeftWall extends AbstractPhysicalScenery{
	
	/** The file path for the scenery image */
	private static final String IMAGE_PATH = "/map/estate/top_left_wall.png";
	 ...
	 */
	public TopLeftWall(float posX, float posY) {
		super(IMAGE_PATH, posX, posY, WALL_DEPTH);
		
		SATPolygon hitbox = new SATPolygon(this);
		hitbox.addVector(0, 0, 75, 0);
		hitbox.addVector(75, 0, 75, 55);
		hitbox.addVector(75, 55, 0, 55);
		hitbox.addVector(0, 55, 0, 0);
		
		SATPolygon hitbox2 = new SATPolygon(this);
		hitbox2.addVector(109, 0, 186, 0);
		hitbox2.addVector(186, 0, 186, 55);
		hitbox2.addVector(186, 55, 109, 55);
		hitbox2.addVector(109, 55, 109, 0);
