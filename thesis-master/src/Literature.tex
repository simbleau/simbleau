...
\subsubsection{Lyon}\label{sec:lyon_lit}
...
\subsubsection{Massively Parallel Vector Graphics}\cite{Ganacim14}
...
\subsubsection{Sort-Middle Architecture}\cite{Levien20}
